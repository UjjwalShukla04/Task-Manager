        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden items-center gap-2 rounded-lg border border-line bg-surface px-2.5 py-1.5 text-[12px] text-muted transition-colors hover:text-fg sm:flex"
